...
::: {.callout-tip}
# Microsoft compiler
Microsoft's old traditional preprocessor is unhappy with `OVERLOAD`, but their newer cross-platform compatible one is fine.
...
The macro writer provides whichever of these makes sense, but the consumer of the macro can use them through the more straightforward call.
